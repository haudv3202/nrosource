...
public class BossID {
    ...
    public static final int Anime_11 = -300;
    public static final int Anime_22 = -301;
    public static final int Anime_33 = -302;

    public static final int THAN_HUY_DIET = -247;
    ...
    public static final int quy_la_la = -35;
    public static final int quy_la_la1 = -37;
    public static final int ong_gia_la = -36;
    ...
    public static final int DE_TU = -216;
    public static final int LUFFY = -303;
    public static final int ZORO = -304;
    public static final int SANJI = -305;
    public static final int CHOPPER = -306;
     public static final int BROCK = -307;
    //Saibamen
