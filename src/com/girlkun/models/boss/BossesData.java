...
//    Tiểu đội one piece
    public static final BossData BOSS_LUFFY = new BossData(
            "LUFFY ĐẠI CA", //name
            ConstPlayer.XAYDA, //gender
            new short[]{582, 583, 584, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            3000000, //dame
            new long[]{5000000000L}, //hp
            new int[]{233}, //map join
            new int[][]{
                {Skill.KAMEJOKO, 7, 1000},
                {Skill.KAMEJOKO, 7, 1000},
                {Skill.TAI_TAO_NANG_LUONG, 2, 3000000},
                {Skill.LIEN_HOAN, 7, 10000},
                {Skill.KHIEN_NANG_LUONG, 2, 10000}}, //skill
            new String[]{"|-1|Khá lắm con trai, dám phá tan giấc mộng của ta...",
                "|-1|Ta không thấy đám Ginyu đâu,... các ngươi đã giết chúng rồi à?",
                "|-1|Tuy không biết các ngươi dùng quỷ kế gì, nhưng ta rất ấn tượng đấy!",
                "|-1|Không thể tha thứ, ta không thể tha cho lũ sâu bọ các ngươi được!!"
    ...
    public static final BossData BOSS_ZORO = new BossData(
            "ZORO NHỊ ĐỆ", //name
            ConstPlayer.XAYDA, //gender
            ...
            new int[][]{
                {Skill.KAMEJOKO, 7, 1000},
                {Skill.THAI_DUONG_HA_SAN, 4, 1000000},
                {Skill.TAI_TAO_NANG_LUONG, 2, 3000000},
                {Skill.LIEN_HOAN, 7, 100}}, //skill
            new String[]{"|-1|Khá lắm con trai, dám phá tan giấc mộng của ta...",
                "|-1|Tuy không biết các ngươi dùng quỷ kế gì, nhưng ta rất ấn tượng đấy!",}, //text chat 1
            new String[]{"|-1|Các ngươi tới số rồi mới gặp phải ta",
                "|-1|Toàn bọn tốt thí,thuyền trưởng để tôi trảm hắn",
                "|-2|Không..thể..nào!!",
                "|-2|Không ngờ..Hắn mạnh cỡ này sao..!!",
                "|-1|Chúng mày nghĩ kiến lại thắng nổi khủng long sao?",
                "|-1|Hô hô hô",
            ...
            new String[]{"|-1|Đợi đó, aaaa..."}, //text chat 3
            REST_10_M //second rest
    );

    public static final BossData BOSS_Sanji = new BossData(
            "SANJI THẬP TAM", //name
            ConstPlayer.XAYDA, //gender
            ...
            new String[]{"|-1|Các ngươi tới số rồi mới gặp phải ta",
                "|-1|Toàn bọn tốt thí",
                "|-2|Không..thể..nào!!",
                "|-2|Hãy để ta biến các ngươi thành món ăn của bọn ta..!!",
                "|-1|Chúng mày nghĩ kiến lại thắng nổi khủng long sao?",
                "|-1|Hô hô hô",
                "|-1|Được thôi, nếu muốn chết đến vậy, ta rất vui lòng!!"
            }, //text chat 2
    ...
    public static final BossData BOSS_Brook = new BossData(
            "BROCK NHỊ ĐẠI", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static final BossData BOSS_Chopper = new BossData(
            "CON CHỒN", //name
            ConstPlayer.XAYDA, //gender
            ...
            new int[]{233}, //map join
              new int[][]{
                {Skill.KAMEJOKO, 7, 100},
                {Skill.HUYT_SAO, 4, 100000},
                {Skill.TAI_TAO_NANG_LUONG, 2, 3000000},
                {Skill.LIEN_HOAN, 7, 10000}}, //skill
            new String[]{"|-1|A Hóa là chúng mày là bọn hải tặc hại nước",
                "|-1|Hãy để ta tiêu diệt để trừ gian diệt bạo"
            }, //text chat 1
            new String[]{"|-1|Các ngươi tới số rồi mới gặp phải ta",
                "|-1|Toàn bọn tốt thí",
                "|-2|Không..thể..nào!!",
                "|-2|Không ngờ..Hắn mạnh cỡ này sao..!!",
                "|-2|Luffy đại ca giúp em với!!",
                "|-1|Chúng mày nghĩ kiến lại thắng nổi khủng long sao?",
                "|-1|Hô hô hô",
                "|-1|Được thôi, nếu muốn chết đến vậy, ta rất vui lòng!!"
            }, //text chat 2
    ...
    public static final BossData BOSS_NAMI = new BossData(
            "NAMI NGỰC BỰ", //name
            ConstPlayer.XAYDA, //gender
            new short[]{183, 184, 185, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            35000, //dame
    ...
    public static final BossData BOSS_Franky = new BossData(
            "FRANKY Máy móc", //name
            ConstPlayer.XAYDA, //gender
            new short[]{183, 184, 185, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            35000, //dame
    ...
    public static final BossData BOSS_Usopp = new BossData(
            "Xạ Thủ ù sóp", //name
            ConstPlayer.XAYDA, //gender
            new short[]{183, 184, 185, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            35000, //dame
    ...
    public static final BossData BOSS_Robin = new BossData(
            "Chị Đại Robin", //name
            ConstPlayer.XAYDA, //gender
            new short[]{183, 184, 185, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            35000, //dame
    ...
    public static final BossData Anime_1 = new BossData(
            "Aoi Akiko", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1295, 1296, 1297, 95, 23, -1}, //outfit {head, body, leg, bag, aura, eff}
            1000000, //dame
            new long[]{500000000}, //hp
            new int[]{213, 214, 215}, //map join
            new int[][]{
                {Skill.DICH_CHUYEN_TUC_THOI, 7, 100000},
                {Skill.DE_TRUNG, 7, 1000},
                {Skill.LIEN_HOAN, 1, 400},
                {Skill.TAI_TAO_NANG_LUONG, 7, 400000},
                {Skill.MASENKO, 2, 300},},//skill//skill
            new String[]{}, //text chat 1
            new String[]{"|-1|Các ngươi thật là yếu ớt",
                "|-1|Chán quá!",
    ...
    public static final BossData Anime_2 = new BossData(
            "Sakura Hikari", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1298, 1299, 1300, 95, 20, -1}, //outfit {head, body, leg, bag, aura, eff}
            1100000, //dame
            new long[]{500000000}, //hp
            new int[]{213, 214, 215}, //map join
            new int[][]{
    ...
    public static final BossData Anime_3 = new BossData(
            "Yumi Misaki", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1301, 1302, 1303, 95, 25, -1}, //outfit {head, body, leg, bag, aura, eff}
            1100000, //dame
            new long[]{500000000}, //hp
            new int[]{213, 214, 215}, //map join
            new int[][]{
