...
public class PlayerService {
    ...
    private static final int COST_GOLD_HOI_SINH_NRSD = 50;
        ...
        if (player.isDie()) {
            ...
            if (MapService.gI().isMapBlackBallWar(player.zone.map.mapId)) {
                ...
                if (player.inventory.gem >= COST_GEM_HOI_SINH) {
                    ...
                    Service.getInstance().sendThongBao(player, "về hổi sinh đi ra bú tiếp " + Util.numberToMoney(COST_GEM_HOI_SINH
